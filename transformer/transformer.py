...
class Transformer(object):
    ...
    def transform(self,strategy,start,end):
        ...
        strategy.load_diversifier()
        strategy.positions = len(strategy.diversifier_set["category"].unique())
        market.connect()
        ...
        complete = processor.merge(all_prices,strategy.diversifier_set,on="ticker")
        return complete
